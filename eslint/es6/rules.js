module.exports = {
    rules: {
        // consistent brace style for blocks, https://eslint.org/docs/rules/brace-style
        ...
        // Require newline at end of file, https://eslint.org/docs/rules/eol-last
        'eol-last': ['error'],
        ...
        // enforce consistent indentation, https://eslint.org/docs/rules/indent
        indent: [
            'error',
            4,
            {
        ...
        // require or disallow semicolons instead of ASI, https://eslint.org/docs/rules/semi
        semi: ['error'],
        ...
        // enforce consistent spacing inside parentheses, https://eslint.org/docs/rules/space-in-parens
        'space-in-parens': ['error', 'never'],

        // enforce consistent spacing after the `//` or `/*` in a comment, https://eslint.org/docs/rules/spaced-comment
        'spaced-comment': [
            'error',
            'always',
            {
